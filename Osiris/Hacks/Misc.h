...
namespace Misc
{
    ...
    void aimware_gui_2() noexcept;

    void aimware_gui_4() noexcept;

    void aimware_gui_5(float width, ImVec2 button_size) noexcept;

    void aimware_gui_6(float width, ImVec2 button_size) noexcept;

    void aimware_gui_7() noexcept;

    void aimware_gui_1() noexcept;

    void aimware_gui_3() noexcept;

    void edgejump(UserCmd* cmd) noexcept;
    void slowwalk(UserCmd* cmd) noexcept;
    void updateClanTag(bool = false) noexcept;
    void blur_in_all() noexcept;
    ...
    void MultidirectionalStrafe(UserCmd* cmd, Vector& orig) noexcept;
